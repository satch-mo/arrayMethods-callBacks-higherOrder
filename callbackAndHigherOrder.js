...
console.log(
  uniq(names, (uniqArr) =>
    console.log(`the new array with deleted duplicate names is ${uniqArr}`)
  )
);
...
// CODE HERE
let addTWELVE = addingFactory(12);
console.log(addTWELVE(4));
